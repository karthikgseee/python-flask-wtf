...
class NameForm(FlaskForm):
    ...
    name4 = StringField('Name4 ?', validators=[DataRequired()])
...
def index():
    ...
    if form.validate_on_submit():
        ...
        if name.lower() in names:
            ...
            message = "That actor is not in our database. Please check and retry, this should be a big line. hope this is big enough to test our multiline"
